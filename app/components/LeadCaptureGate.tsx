...
import { Lock, User, Phone, Mail, Loader2, CheckCircle2 } from "lucide-react";
    ...
    >
      ...
      <div style={{ textAlign: "center", marginBottom: 22 }}>
        ...
        <p style={{ fontSize: 13, opacity: 0.75, lineHeight: 1.7 }}>
          {message ||
            "تواصل سريع وآمن — سيرد عليك الوسيط مباشرة. بياناتك محفوظة وفق نظام حماية البيانات الشخصية (PDPL)."}
        </p>
      </div>
