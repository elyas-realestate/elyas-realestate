...
const THEMES: Array<{
...
}> = [
  {
    ...
    description:
      "الثيم الافتراضي — كريمي ناعم بنبرة عقارية فخمة، مستوحى من العلامات العقارية الراقية",
...
export default function ThemeSwitcher() {
  ...
  return (
    ...
    >
      ...
      >
        💡 ملاحظة: الثيم يطبَّق على كل صفحات الداشبورد فوراً. الصفحة التسويقية الرئيسية لها تصميم
        مستقل.
      </div>
    </div>
  );
