        ...
        <section id="contact" className="section-pad" style={{ padding:'100px 48px', textAlign:'center', position:'relative', overflow:'hidden', background: clrBgPrimary }}>
          ...
          <div className="card cta-card relative" style={{ maxWidth:720, margin:'0 auto', padding:'64px 48px', borderRadius:24 }}>
            ...
            <div className="flex justify-center gap-4 flex-wrap">
              ...
              {phone && (
                <a href={"tel:" + phone} className="no-underline text-white font-semibold flex items-center gap-2" style={{ padding:'14px 36px', borderRadius:12, fontSize:15, border:'1px solid rgba(198,145,76,0.12)' }}>
        ...
        <div className="footer-grid" style={{ display:'grid', gridTemplateColumns:'1.5fr 1fr 1fr 1fr', gap:48, maxWidth:1200, margin:'0 auto 48px' }}>
          <div>
            ...
            <div className="flex flex-wrap gap-2" style={{ marginTop:20 }}>
              {social_x && (
                <a href={social_x} target="_blank" rel="noopener noreferrer" className="social-icon no-underline flex items-center justify-center" style={{ width:40, height:40, borderRadius:10, border:'1px solid rgba(198,145,76,0.12)', transition:'all 0.3s' }}>
              ...
              {social_instagram && (
                <a href={social_instagram} target="_blank" rel="noopener noreferrer" className="social-icon no-underline flex items-center justify-center" style={{ width:40, height:40, borderRadius:10, border:'1px solid rgba(198,145,76,0.12)', transition:'all 0.3s' }}>
              ...
              {social_tiktok && (
                <a href={social_tiktok} target="_blank" rel="noopener noreferrer" className="social-icon no-underline flex items-center justify-center" style={{ width:40, height:40, borderRadius:10, border:'1px solid rgba(198,145,76,0.12)', transition:'all 0.3s' }}>
              ...
              {social_snapchat && (
                <a href={social_snapchat} target="_blank" rel="noopener noreferrer" className="social-icon no-underline flex items-center justify-center" style={{ width:40, height:40, borderRadius:10, border:'1px solid rgba(198,145,76,0.12)', transition:'all 0.3s' }}>
              ...
              {social_linkedin && (
                <a href={social_linkedin} target="_blank" rel="noopener noreferrer" className="social-icon no-underline flex items-center justify-center" style={{ width:40, height:40, borderRadius:10, border:'1px solid rgba(198,145,76,0.12)', transition:'all 0.3s' }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                </a>
              )}
              {social_youtube && (
                <a href={social_youtube} target="_blank" rel="noopener noreferrer" className="social-icon no-underline flex items-center justify-center" style={{ width:40, height:40, borderRadius:10, border:'1px solid rgba(198,145,76,0.12)', transition:'all 0.3s' }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                </a>
              )}
              {social_threads && (
                <a href={social_threads} target="_blank" rel="noopener noreferrer" className="social-icon no-underline flex items-center justify-center" style={{ width:40, height:40, borderRadius:10, border:'1px solid rgba(198,145,76,0.12)', transition:'all 0.3s' }}>
              ...
              {social_facebook && (
                <a href={social_facebook} target="_blank" rel="noopener noreferrer" className="social-icon no-underline flex items-center justify-center" style={{ width:40, height:40, borderRadius:10, border:'1px solid rgba(198,145,76,0.12)', transition:'all 0.3s' }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
              )}
              {social_whatsapp_link && (
                <a href={social_whatsapp_link} target="_blank" rel="noopener noreferrer" className="social-icon no-underline flex items-center justify-center" style={{ width:40, height:40, borderRadius:10, border:'1px solid rgba(198,145,76,0.12)', transition:'all 0.3s' }}>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              {(navbar_links as any[]).filter((l: any) => l.type !== "cta").map((link: any, i: number) => (
                link.type === "anchor" ? <a key={i} href={link.href} className="no-underline text-[#9A9AA0] hover:text-[#C6914C] text-sm" style={{ transition:'color 0.3s' }}>{link.label}</a> : <Link key={i} href={link.href} className="no-underline text-[#9A9AA0] hover:text-[#C6914C] text-sm" style={{ transition:'color 0.3s' }}>{link.label}</Link>
              ))}
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              {whatsapp && <a href={"https://wa.me/" + whatsapp} className="no-underline text-[#9A9AA0] hover:text-[#C6914C] text-sm" style={{ transition:'color 0.3s' }}>واتساب</a>}
              {email && <a href={"mailto:" + email} className="no-underline text-[#9A9AA0] hover:text-[#C6914C] text-sm" style={{ transition:'color 0.3s' }}>{email}</a>}
              {phone && <a href={"tel:" + phone} className="no-underline text-[#9A9AA0] hover:text-[#C6914C] text-sm" style={{ transition:'color 0.3s' }}>{phone}</a>}
