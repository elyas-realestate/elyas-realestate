  ...
  return (
    <div dir="rtl">
      <div className="flex items-center justify-between mb-8">
        ...
        <button onClick={handleSave} disabled={saving} className={"flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-lg transition " + (saved ? "bg-green-600" : "bg-[#C9A84C] hover:bg-[#A68A3A]")}>
      ...
      <div className="flex gap-6">
        ...
        <div className="w-56 flex-shrink-0 space-y-1">
          {sections.map(sec => (
            <button key={sec.id} onClick={() => setActiveSection(sec.id)} className={"w-full text-right flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition " + (activeSection === sec.id ? "bg-[#C9A84C] text-white" : "text-[#9A9AA0] hover:text-white hover:bg-[#16161A]")}>
        ...
        <div className="flex-1 max-w-3xl">
          ...
          {activeSection === "general" && (
            <div className="bg-[#16161A] border border-[rgba(201,168,76,0.12)] rounded-xl p-6 space-y-5">
              ...
              <div>
                ...
                <input value={settings.site_name || ""} onChange={e => handleChange("site_name", e.target.value)} className="w-full bg-[#1C1C22] border border-[rgba(201,168,76,0.15)] rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C]" />
              </div>
              <div>
                <label className="block text-sm text-[#9A9AA0] mb-2">رقم رخصة فال</label>
                <input value={settings.fal_license || ""} onChange={e => handleChange("fal_license", e.target.value)} className="w-full bg-[#1C1C22] border border-[rgba(201,168,76,0.15)] rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C]" placeholder="مثال: 7001234567" />
              </div>
              <div>
                <label className="block text-sm text-[#9A9AA0] mb-2">منطقة التغطية</label>
                <input value={settings.coverage_text || ""} onChange={e => handleChange("coverage_text", e.target.value)} className="w-full bg-[#1C1C22] border border-[rgba(201,168,76,0.15)] rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C]" placeholder="مثال: شمال وشرق الرياض" />
              </div>
              <div>
                <label className="block text-sm text-[#9A9AA0] mb-2">نص زر تسجيل الدخول <span className="text-[#5A5A62]">(يظهر في النافبار للفريق)</span></label>
                <input value={settings.login_link_text || ""} onChange={e => handleChange("login_link_text", e.target.value)} className="w-full bg-[#1C1C22] border border-[rgba(201,168,76,0.15)] rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C]" placeholder="دخول الفريق" />
              </div>
            </div>
          )}
          ...
          {activeSection === "contact" && (
            <div className="space-y-6">
              <div className="bg-[#16161A] border border-[rgba(201,168,76,0.12)] rounded-xl p-6 space-y-5">
                <h3 className="font-bold text-[#C9A84C] text-lg mb-4">أرقام التواصل</h3>
                <div>
                  <label className="block text-sm text-[#9A9AA0] mb-2">رقم الجوال <span className="text-[#5A5A62]">(مع مفتاح الدولة)</span></label>
                  <input value={settings.phone || ""} onChange={e => handleChange("phone", e.target.value)} className="w-full bg-[#1C1C22] border border-[rgba(201,168,76,0.15)] rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C]" placeholder="+966501234567" dir="ltr" />
                </div>
                <div>
                  <label className="block text-sm text-[#9A9AA0] mb-2">رقم الواتساب <span className="text-[#5A5A62]">(بدون + — مثال: 966501234567)</span></label>
                  <input value={settings.whatsapp || ""} onChange={e => handleChange("whatsapp", e.target.value)} className="w-full bg-[#1C1C22] border border-[rgba(201,168,76,0.15)] rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C]" placeholder="966501234567" dir="ltr" />
                </div>
                <div>
                  <label className="block text-sm text-[#9A9AA0] mb-2">البريد الإلكتروني</label>
                  <input value={settings.email || ""} onChange={e => handleChange("email", e.target.value)} className="w-full bg-[#1C1C22] border border-[rgba(201,168,76,0.15)] rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C]" placeholder="info@example.com" dir="ltr" />
                </div>
              </div>
              <div className="bg-[#16161A] border border-[rgba(201,168,76,0.12)] rounded-xl p-6 space-y-5">
                <h3 className="font-bold text-[#C9A84C] text-lg mb-4">حسابات السوشال ميديا</h3>
                <div>
                  <label className="block text-sm text-[#9A9AA0] mb-2">X (تويتر)</label>
                  <input value={settings.social_x || ""} onChange={e => handleChange("social_x", e.target.value)} className="w-full bg-[#1C1C22] border border-[rgba(201,168,76,0.15)] rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C]" placeholder="https://x.com/username" dir="ltr" />
                </div>
                <div>
                  <label className="block text-sm text-[#9A9AA0] mb-2">Instagram</label>
                  <input value={settings.social_instagram || ""} onChange={e => handleChange("social_instagram", e.target.value)} className="w-full bg-[#1C1C22] border border-[rgba(201,168,76,0.15)] rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C]" placeholder="https://instagram.com/username" dir="ltr" />
                </div>
                <div>
                  <label className="block text-sm text-[#9A9AA0] mb-2">TikTok</label>
                  <input value={settings.social_tiktok || ""} onChange={e => handleChange("social_tiktok", e.target.value)} className="w-full bg-[#1C1C22] border border-[rgba(201,168,76,0.15)] rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C]" placeholder="https://tiktok.com/@username" dir="ltr" />
                </div>
                <div>
                  <label className="block text-sm text-[#9A9AA0] mb-2">LinkedIn</label>
                  <input value={settings.social_linkedin || ""} onChange={e => handleChange("social_linkedin", e.target.value)} className="w-full bg-[#1C1C22] border border-[rgba(201,168,76,0.15)] rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C]" placeholder="https://linkedin.com/in/username" dir="ltr" />
                </div>
              </div>
            </div>
          )}
            ...
            <div className="space-y-6">
              <div className="bg-[#16161A] border border-[rgba(201,168,76,0.12)] rounded-xl p-6 space-y-5">
                ...
                <div>
                  ...
                  <input value={settings.hero_badge || ""} onChange={e => handleChange("hero_badge", e.target.value)} className="w-full bg-[#1C1C22] border border-[rgba(201,168,76,0.15)] rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C]" />
                </div>
                <div>
                  <label className="block text-sm text-[#9A9AA0] mb-2">العنوان الرئيسي</label>
                  <input value={settings.hero_title || ""} onChange={e => handleChange("hero_title", e.target.value)} className="w-full bg-[#1C1C22] border border-[rgba(201,168,76,0.15)] rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C] text-lg font-bold" />
                </div>
                <div>
                  <label className="block text-sm text-[#9A9AA0] mb-2">الوصف التعريفي</label>
                  <textarea value={settings.hero_subtitle || ""} onChange={e => handleChange("hero_subtitle", e.target.value)} rows={3} className="w-full bg-[#1C1C22] border border-[rgba(201,168,76,0.15)] rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C]" />
                </div>
                <div>
                  <label className="block text-sm text-[#9A9AA0] mb-2">صورة الخلفية <span className="text-[#5A5A62]">(رابط الصورة — URL)</span></label>
                  <input value={settings.hero_image || ""} onChange={e => handleChange("hero_image", e.target.value)} className="w-full bg-[#1C1C22] border border-[rgba(201,168,76,0.15)] rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C] text-sm" dir="ltr" placeholder="https://images.unsplash.com/..." />
                  {settings.hero_image && (
          ...
          {activeSection === "navbar" && (
            <div className="bg-[#16161A] border border-[rgba(201,168,76,0.12)] rounded-xl p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={addNavLink} className="text-sm bg-[#1C1C22] hover:bg-[#2A2A32] px-4 py-2 rounded-lg transition flex items-center gap-2"><Plus size={14} /> إضافة رابط</button>
              </div>
          ...
          {activeSection === "services" && (
            <div className="bg-[#16161A] border border-[rgba(201,168,76,0.12)] rounded-xl p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={addService} className="text-sm bg-[#1C1C22] hover:bg-[#2A2A32] px-4 py-2 rounded-lg transition flex items-center gap-2"><Plus size={14} /> إضافة خدمة</button>
              </div>
              <div className="space-y-4">
          ...
          {activeSection === "why" && (
            <div className="bg-[#16161A] border border-[rgba(201,168,76,0.12)] rounded-xl p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={addWhyCard} className="text-sm bg-[#1C1C22] hover:bg-[#2A2A32] px-4 py-2 rounded-lg transition flex items-center gap-2"><Plus size={14} /> إضافة بطاقة</button>
              </div>
              <div className="space-y-4">
            ...
            <div className="space-y-6">
              <div className="bg-[#16161A] border border-[rgba(201,168,76,0.12)] rounded-xl p-6 space-y-5">
                ...
                <div>
                  ...
                  <input value={settings.cta_title || ""} onChange={e => handleChange("cta_title", e.target.value)} className="w-full bg-[#1C1C22] border border-[rgba(201,168,76,0.15)] rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C]" />
                </div>
                <div>
                  <label className="block text-sm text-[#9A9AA0] mb-2">وصف قسم التواصل</label>
                  <textarea value={settings.cta_subtitle || ""} onChange={e => handleChange("cta_subtitle", e.target.value)} rows={2} className="w-full bg-[#1C1C22] border border-[rgba(201,168,76,0.15)] rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C]" />
                </div>
              </div>
              <div className="bg-[#16161A] border border-[rgba(201,168,76,0.12)] rounded-xl p-6 space-y-5">
                ...
                <div>
                  ...
                  <textarea value={settings.footer_text || ""} onChange={e => handleChange("footer_text", e.target.value)} rows={3} className="w-full bg-[#1C1C22] border border-[rgba(201,168,76,0.15)] rounded-lg px-4 py-3 focus:outline-none focus:border-[#C9A84C]" />
                </div>
              </div>
            </div>
          )}
