    ...
    <div className="space-y-5">
            ...
            >
                ...
                <div className="flex items-center gap-2">
                  <span
                    style={{
                      ...
                      height: 10,
                      borderRadius: "50%",
                      background: m.tenant_enabled ? "var(--success)" : "var(--text-faint)",
                    }}
                  />
                  ...
                  <span
                    ...
                    style={{ background: "var(--bg-surface-2)", color: "var(--text-faint)" }}
                  >
                    {m.department}
                  </span>
                </div>
                <Link
                  href={`/dashboard/organization/manager/${m.id}`}
              ...
              <div className="grid grid-cols-1 gap-2 md:grid-cols-2">
                {team.map((e) => (
                  <Link
                    key={e.id}
                    href={`/dashboard/organization/employee/${e.id}`}
                    ...
                    <div className="flex min-w-0 flex-1 items-center gap-2">
                      <span
                        style={{
                          ...
                          height: 7,
                          borderRadius: "50%",
                          background: e.tenant_enabled ? "var(--success)" : "var(--text-faint)",
                        }}
                      />
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="truncate text-xs" style={{ color: "var(--text-faint)" }}>
                          {e.default_ai_provider}/{e.default_ai_model}
                        </div>
                      </div>
                    </div>
                ...
                {team.length === 0 && (
                  <div
                    className="col-span-2 py-3 text-center text-xs"
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
        <Link
          ...
          className="flex items-center gap-2 rounded-lg p-3 no-underline"
        ...
        >
          ...
          <div>
            <div className="text-sm font-bold" style={{ color: "var(--text-strong)" }}>
              مراجعات المدراء اليومية
            </div>
            <div className="text-xs" style={{ color: "var(--text-faint)" }}>
              ماذا قال كل مدير عن فريقه أمس
            </div>
          </div>
        </Link>
        <Link
