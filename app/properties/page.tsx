    ...
    <div dir="rtl" style={{ fontFamily: "'Tajawal', sans-serif" }}>
      ...
      >
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
          <div
            className="accent inline-flex items-center gap-2"
            style={{
              fontSize: 12,
              fontWeight: 600,
              letterSpacing: 1.5,
          ...
          <h1
            className="font-kufi font-black"
            style={{
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                padding: "10px 16px",
                borderRadius: 10,
                background: showFilters ? "var(--gold-bg)" : "var(--bg-surface-2)",
                border:
                  "1px solid " + (showFilters ? "var(--gold-bg-strong)" : "var(--gold-bg-soft)"),
                ...
                {offerFilters.map((f) => (
                  <button
                    ...
                    style={{
                      ...
                      fontFamily: "'Tajawal', sans-serif",
                      background:
                        offerFilter === f.value ? "var(--gold-bg-hover)" : "var(--bg-surface-2)",
                      color: offerFilter === f.value ? "var(--gold-2)" : "var(--text-soft)",
                      border:
                        "1px solid " +
                        (offerFilter === f.value ? "var(--gold-bg-strong)" : "var(--gold-bg-soft)"),
                    }}
                  >
                    {f.label}
                  </button>
                ...
                {categoryFilters.map((f) => (
                  <button
                    ...
                    style={{
                      ...
                      fontFamily: "'Tajawal', sans-serif",
                      background:
                        catFilter === f.value ? "var(--gold-bg-hover)" : "var(--bg-surface-2)",
                      color: catFilter === f.value ? "var(--gold-2)" : "var(--text-soft)",
                      border:
                        "1px solid " +
                        (catFilter === f.value ? "var(--gold-bg-strong)" : "var(--gold-bg-soft)"),
                    }}
                  >
                    {f.label}
                  </button>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            {loading ? (
              ...
              <>
                <span
                  className="font-kufi"
                  style={{ fontSize: 22, fontWeight: 800, color: "var(--gold-2)" }}
                >
                  {filtered.length}
                </span>
        ...
        >
          ...
          <div
            style={{
              ...
              right: 0,
              height: 80,
              background: "linear-gradient(to top, rgba(22,22,26,1), transparent)",
            }}
          ></div>
        </div>
        ...
        <div style={{ padding: "20px 20px 22px" }}>
          ...
          {price ? (
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <span
                className="font-kufi"
                style={{ fontSize: 20, fontWeight: 800, color: "var(--gold-2)" }}
              >
                {price}
              </span>
