...
export default function PropertyPrintView() {
  ...
  if (loading)
    return (
      <div dir="rtl" style={{ padding: 40, fontFamily: "'Tajawal', sans-serif" }}>
        جاري تجهيز المستند للطباعة...
      </div>
    );
  if (!property)
    return (
    ...
    >
      ...
      <div
        style={{
          ...
          alignItems: "center",
          borderBottom: "2px solid var(--gold-2)",
          paddingBottom: "20px",
          marginBottom: "30px",
        }}
      >
        <div>
          <h2 style={{ margin: 0, fontWeight: 900, fontSize: "28px", color: "#111" }}>
            {brokerName}
          </h2>
      ...
      {/* Title & Info */}
      <h1 style={{ fontSize: "24px", fontWeight: 800, marginBottom: "10px", lineHeight: "1.4" }}>
        {property.title}
      </h1>
      ...
      >
        ...
        >
          ...
          >
            <span style={{ fontSize: "28px", fontWeight: 900, color: "var(--gold-2)" }}>
              {price}
            </span>
        ...
        <div style={{ flex: "2", display: "flex", flexWrap: "wrap", gap: "15px" }}>
          {[
            ...
            {
              label: "مسطح البناء",
              value: property.built_area ? property.built_area + " م²" : null,
            },
      ...
      >
        <div>
          <p style={{ margin: "0 0 5px 0" }}>
            <strong>التواصل:</strong> {property.contact_phone || settings?.phone || "-"}
          </p>
          {property.ad_license_number && (
            <p style={{ margin: 0 }}>
              <strong>ترخيص الإعلان:</strong> {property.ad_license_number}
            </p>
          )}
        </div>
        <div
        ...
        >
          <p style={{ margin: "0 0 8px 0" }}>
            تم الإنشاء بواسطة <strong>استوديوهات منصة وسيط برو</strong>
          </p>
          <button
            className="no-print"
