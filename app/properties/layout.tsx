...
export default function PropertiesLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen" dir="rtl" style={{ background: "#0A0A0C", color: "#F5F5F5", fontFamily: "'Tajawal', sans-serif" }}>
      ...
      {/* NAVBAR */}
      <nav style={{ position: "sticky", top: 0, zIndex: 50, height: 72, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 48px", background: "rgba(22,22,26,0.9)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", borderBottom: "1px solid rgba(198,145,76,0.12)" }}>
      ...
      {/* FOOTER */}
      <footer style={{ background: "#111114", borderTop: "1px solid rgba(198,145,76,0.12)", padding: "48px 48px 28px" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", paddingTop: 24, borderTop: "1px solid rgba(198,145,76,0.08)", display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 12, color: "#5A5A62" }}>
