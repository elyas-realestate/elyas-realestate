  ...
  return (
    ...
    >
      <style>{`
        ...
        .prop-nav-link { color: var(--text-soft); text-decoration: none; font-size: 14px; font-weight: 500; transition: color 0.3s; }
        .prop-nav-link:hover { color: var(--text-strong); }
        /* Mobile nav drawer */
        .prop-drawer {
        ...
        .prop-drawer a { padding: 14px 0; border-bottom: 1px solid var(--overlay-soft); font-size: 15px; color: var(--text-soft); text-decoration: none; display: block; }
        .prop-drawer a:last-child { border-bottom: none; }
        .prop-nav-desktop { display: flex; align-items: center; gap: 32px; }
        .prop-hamburger { display: none; background: none; border: 1px solid var(--gold-bg-hover); border-radius: 10px; padding: 8px 10px; cursor: pointer; color: var(--text-soft); }
