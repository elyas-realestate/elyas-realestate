    ...
    <div style={{
      ...
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        ...
        <Section title="القبول بالشروط">
          <p>
            باستخدامك منصّة <strong style={{ color: "var(--gold-1)" }}>وسيط برو</strong>،
            توافق على الالتزام بهذه الشروط. إن لم توافق، يُرجى عدم استخدام المنصّة.
          </p>
        </Section>

        <Section title="وصف الخدمة">
          <p>
            وسيط برو منصّة SaaS تقدّم خدمات الوساطة والتسويق العقاري عبر منظومة
            ذكاء اصطناعي متعدّدة الوكلاء (Multi-Agent System) لمساعدة الوسطاء العقاريين
            المرخّصين في المملكة العربية السعودية على إدارة أعمالهم.
          </p>
        </Section>

        <Section title="شروط الاستخدام">
          <ul>
            <li>يجب أن تكون وسيطاً عقارياً مرخّصاً من الهيئة العامة للعقار (REGA) لاستخدام الميزات الكاملة.</li>
            <li>تتحمّل المسؤولية الكاملة عن دقة المحتوى الذي تنشره عبر المنصّة.</li>
            <li>تلتزم بأنظمة المملكة العربية السعودية، خصوصاً أنظمة العقار، الإعلان، حماية المستهلك، وحماية البيانات.</li>
        ...
        <Section title="المسؤولية عن قرارات الذكاء الاصطناعي">
          <p>
            المنصّة تستخدم نماذج ذكاء اصطناعي لإنتاج محتوى، الرد على عملاء، واقتراح
            توصيات. <strong>القرار النهائي يبقى دائماً للوسيط المرخّص.</strong> تُوفّر
            المنصّة <strong>بوّابات موافقة (Approval Gates)</strong> توقف القرارات الحرجة
            (تخفيض السعر، إلغاء عقد، التزامات قانونية) قبل التنفيذ، وتطلب موافقتك الصريحة.
          </p>
          <p>
            باستخدامك للمنصّة، تُقرّ بأن مسؤولية المخرجات النهائية تقع عليك بصفتك
            الوسيط المرخّص، ولا تتحمّل المنصّة المسؤولية عن أي قرار اعتمدته أنت.
          </p>
        </Section>
        ...
        <Section title="الاشتراكات والدفع">
          <ul>
            ...
            <li>يمكنك إلغاء الاشتراك في أي وقت من إعدادات حسابك. يبقى وصولك متاحاً حتى نهاية الفترة المدفوعة.</li>
        ...
        <Section title="الملكية الفكرية">
          <p>
            المحتوى الذي تُنشئه (توجيهاتك الاستراتيجية، قاعدة معرفتك، عقاراتك، عملاؤك)
            ملكك الكامل. منصّة وسيط برو وكودها وتصميمها ملكية فكرية للمالك (إلياس الدخيل).
          </p>
        </Section>

        <Section title="حدود المسؤولية">
          <p>
            تُقدَّم المنصّة "كما هي". نسعى لأقصى جودة وثبات، لكن لا نضمن خلوّها من
            انقطاعات أو أخطاء. مسؤوليتنا الإجمالية لا تتجاوز قيمة اشتراكك للشهر الذي
            وقع فيه الضرر.
          </p>
        </Section>
        ...
        <Section title="الإلغاء">
          <p>
            يحق لنا إنهاء حسابك دون إشعار في حال:
          </p>
          <ul>
        ...
        <Section title="القانون الحاكم">
          <p>
            تخضع هذه الشروط لأنظمة المملكة العربية السعودية. أي نزاع يُحَل عبر
            المحاكم المختصّة في مدينة الرياض.
          </p>
        </Section>

        <Section title="التواصل">
          <p style={{ lineHeight: 2 }}>
            للاستفسارات عن هذه الشروط:<br />
