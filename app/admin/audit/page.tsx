      ...
      >
        <div>
          ...
          <p style={{ fontSize: 13, color: "var(--text-disabled)" }}>
            آخر {events.length} نشاط عبر كل المستأجرين
          </p>
        </div>
                  ...
                  return (
                    <tr key={e.id} style={{ borderTop: "1px solid rgba(255,255,255,0.04)" }}>
                      ...
                      <td style={{ padding: "10px 14px", fontSize: 12 }}>
                        {e.tenant_slug ? (
                          <Link
                            href={`/admin/tenants/${e.tenant_id}`}
                            style={{
                              color: "var(--purple-ai)",
                              direction: "ltr",
                              display: "inline-block",
                      ...
                      <td
                        style={{ padding: "10px 14px", color: "var(--text-muted)", fontSize: 12 }}
                      >
                        {e.entity_type && (
                          <span style={{ color: "var(--text-ghost)" }}>{e.entity_type}</span>
                        )}
                        {e.entity_name && (
                          <span style={{ color: "var(--text-secondary)", marginInlineStart: 6 }}>
                            {e.entity_name}
                          </span>
                        )}
