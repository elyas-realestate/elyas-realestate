    ...
    <div>
      ...
      >
        <div>
          ...
          <p style={{ fontSize: 13, color: "var(--text-disabled)" }}>
            إيرادات شهرية وسنوية، خطط نشطة، ومدفوعة
          </p>
        </div>
        <button
          onClick={load}
      ...
      >
        {[
          {
            label: "MRR — دخل شهري",
            value: summary ? `${summary.mrr.toLocaleString("en-US")} ر.س` : "—",
            icon: DollarSign,
            color: "var(--success-2)",
          ...
          {
            label: "ARR — دخل سنوي",
            value: summary ? `${summary.arr.toLocaleString("en-US")} ر.س` : "—",
            icon: TrendingUp,
            color: "var(--gold-1)",
