...
const ENV_VARS = [
  ...
  },
  {
    ...
    label: "Admin Email",
    status: process.env.NEXT_PUBLIC_ADMIN_EMAIL ? "set" : "missing",
    icon: Shield,
  },
    ...
    <div>
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ fontSize: 13, color: "var(--text-disabled)" }}>
          متغيرات البيئة والإعدادات التقنية
        </p>
      </div>
      ...
      >
        <h2 style={{ fontSize: 14, fontWeight: 700, color: "var(--text-muted)", marginBottom: 16 }}>
          متغيرات البيئة
        </h2>
        ...
        <p style={{ fontSize: 12, color: "var(--border-1)", marginTop: 14, lineHeight: 1.6 }}>
          * حالة مفاتيح AI تظهر كـ "غير محدد" لأنها server-only ولا يمكن قراءتها من المتصفح. تحقق من
        ...
        {!process.env.NEXT_PUBLIC_ADMIN_EMAIL && (
          ...
          >
            <p style={{ fontSize: 12, color: "var(--danger)", lineHeight: 1.6 }}>
              ...
              <code
                style={{ background: "rgba(239,68,68,0.08)", padding: "1px 5px", borderRadius: 3 }}
              >
