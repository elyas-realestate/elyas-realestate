      ...
      >
        <div style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
          ...
          <p style={{ fontSize: 12, color: "var(--purple-2)", lineHeight: 1.7 }}>
            تغيير الخطة يدوياً متاح من <strong>صفحة نظرة عامة</strong> → الاشتراك الحالي. بوابة
            الدفع الإلكتروني قيد التطوير وستُربط بـ Stripe أو MyFatoorah.
          </p>
        </div>
      </div>
    </div>
