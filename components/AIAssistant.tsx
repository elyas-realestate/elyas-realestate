...
const QUICK_PROMPTS = [
  {
    label: "وصف عقار",
    prompt:
      "اكتب لي وصفاً احترافياً لشقة 3 غرف في الرياض، حي النرجس، مساحة 180م²، بسعر 850,000 ريال",
  },
  ...
  {
    label: "صياغة عقد",
    prompt: "ما البنود الأساسية التي يجب أن يتضمنها عقد إيجار سكني في السعودية؟",
  },
];
...
export default function AIAssistant() {
  ...
  async function sendMessage(text?: string) {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { role: "assistant", content: "⚠️ تعذّر الاتصال — تحقق من اتصالك بالإنترنت" },
      ]);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <>
      ...
      >
        {open ? <ChevronDown size={20} color="#F5F5F5" /> : <Bot size={20} color="#0A0A0C" />}
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 13, fontWeight: 700, color: "#F5F5F5", lineHeight: 1.2 }}>
              وكيل برو AI
            </div>
              ...
              >
                <div
                  style={{
                    ...
                    background: msg.role === "user" ? "rgba(198,145,76,0.12)" : "#1C1C22",
                    border:
                      msg.role === "user"
