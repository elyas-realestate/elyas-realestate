...
export const ELEMENTS: ProfileElement[] = [
  ...
  },
  {
    ...
    label: "انستجرام",
    icon: Instagram,
    brandBg: "linear-gradient(135deg, #833AB4, #FD1D1D, #FCB045)",
    brandFg: "#FFFFFF",
  ...
  // ════════ CONTACT — تُسحَب تلقائياً من /dashboard/settings ════════
  {
    ...
    buildUrl: (v) => {
      ...
      const full = digits.startsWith("966")
        ? digits
  ...
  // ════════ FORM ════════
  {
    type: "form_whatsapp_orders",
    category: "form",
    label: "طلبات على واتساب",
    icon: MessageSquare,
    brandBg: "#25D366",
    brandFg: "#FFFFFF",
    ...
    fields: [
      {
        key: "phone",
        label: "رقم الواتساب لاستقبال الطلبات",
        type: "tel",
      ...
      },
      {
        ...
        label: "عنوان الخدمة",
        type: "text",
        placeholder: "اطلب خدمة استشارة عقارية",
      },
      {
        key: "description",
        label: "وصف الخدمة",
        type: "textarea",
        placeholder: "اشرح ما يحصل عليه الزائر...",
      },
    ],
    buildUrl: (v) => {
      const digits = (v.phone || "").replace(/\D/g, "").replace(/^0+/, "");
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "الوصف",
        type: "textarea",
        placeholder: "أرسل رسالتك وسأرد قريباً",
      },
  ...
  {
    type: "content_aqar_listings",
    category: "content",
    label: "عقاراتي على عقار.fm",
    icon: Building2,
    brandBg: "#10B981",
    brandFg: "#FFFFFF",
    emoji: "🏘️",
  ...
  {
    type: "content_bayut_listings",
    category: "content",
    label: "عقاراتي على بيوت",
    icon: Building2,
    brandBg: "#A52F50",
    brandFg: "#FFFFFF",
    emoji: "🏢",
  ...
  {
    type: "content_request_property",
    category: "content",
    label: "اطلب عقاراً (بحث مخصص)",
    icon: Building2,
    brandBg: "#3B82F6",
    brandFg: "#FFFFFF",
    emoji: "🔍",
    description: "زر يأخذ العميل لنموذج تقديم طلب عقار جديد",
    fields: [{ key: "label", label: "نص الزر", type: "text", placeholder: "اطلب بحث عقاري مخصص" }],
    ...
    fields: [
      {
        ...
        label: "النص",
        type: "textarea",
        placeholder: "أكثر من 8 سنوات في السوق العقاري بالرياض...",
        required: true,
      },
    ],
    defaultLabel: "فقرة",
